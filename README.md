...
- DONE Fork and clone this project and cd into your cloned version.
- DONE `npm install` will pull in all the node_modules you need.
- DONE `npm start` will start a development server on your `http://localhost:3000`.
